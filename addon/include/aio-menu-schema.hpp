...
inline constexpr NRSetting kSettings[] = {
    ...
    { "NvidiaOpticalFlowMotionRepair", "Geometry/confidence motion repair", NR_FLOAT, 1, 0, 1, "%.2f", nullptr, 0,
      "With geometry enabled, replaces unreliable edge motion with trustworthy motion from the same depth surface. Zero preserves the original vectors.", Group::Neural },
