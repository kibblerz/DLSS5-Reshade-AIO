...
inline constexpr NRSetting kSettings[] = {
    ...
    { "NvidiaOpticalFlowCost", "Optical Flow cost tolerance", NR_FLOAT, 0.35f, 0, 0.99f, "%.2f", nullptr, 0,
      "Higher values accept lower-confidence motion when building the rejection mask.", Group::Neural },
    { "NvidiaOpticalFlowNrMask", "Apply Optical Flow rejection mask to NR (experimental)", NR_BOOL, 0, 0, 1, nullptr, nullptr, 0,
      "Off by default. Forwards the Optical Flow confidence/rejection texture to NR as its control mask; this may suppress NR in rejected regions.", Group::Neural },
