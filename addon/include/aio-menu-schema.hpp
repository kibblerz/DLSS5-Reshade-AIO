...
inline constexpr NRSetting kSettings[] = {
    ...
    { "NvidiaOpticalFlowMotionRepair", "Geometry/object motion and confidence fill", NR_FLOAT, 1, 0, 1, "%.2f", nullptr, 0,
      "Uses trustworthy samples from the same depth surface to repair motion and smooth rejection inward within an object without crossing its silhouette. Zero preserves the original data.", Group::Neural },
